...
describe("GET /api/tasks", () => {
  ...
  it("ファミリーのアクティブタスクを返すこと（completedToday付き）", async () => {
    ...
    expect(json).toEqual([
      { ...tasks[0], completedToday: false, lastSkippedDate: null, lastSkippedActiveDaysAgo: null, carryOverMissedCount: null },
      { ...tasks[1], completedToday: false, lastSkippedDate: null, lastSkippedActiveDaysAgo: null, carryOverMissedCount: null },
    ]);
  ...
  it("当日にAPPROVEDのクエストがあるタスクはcompletedToday=trueになること", async () => {
    ...
    expect(json).toEqual([
      { ...tasks[0], completedToday: true, lastSkippedDate: null, lastSkippedActiveDaysAgo: null, carryOverMissedCount: null },
      { ...tasks[1], completedToday: false, lastSkippedDate: null, lastSkippedActiveDaysAgo: null, carryOverMissedCount: null },
    ]);
