      ...
      <div className={s.container}>
        ...
        <div className={s.stepsGrid}>
          {[
            ...
            { n: "04", icon: "🐉", title: "XP でモンスターが進化・転生", desc: "XP が貯まるとモンスターが成長・進化。最終形態に達すると「転生ボタン」が出現。勉強・体力・生活力の卵を自分で選んで次サイクルをスタート！選んだ卵の系統は進化確率+20%のボーナス。さらに頑張った日には宝箱（親ごほうび or 季節コレクション全80種）が出現し、100種の実績バッジも狙える。" },
          ].map((step, i) => (
